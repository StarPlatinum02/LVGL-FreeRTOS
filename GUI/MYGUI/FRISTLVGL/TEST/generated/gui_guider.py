...
screen_cont_1.set_size(240, 320)
...
screen_img_1.set_src("B:MicroPython/_cat1_alpha_240x320.bin")
...
screen_btn_1_label.set_text("喵喵")
...
screen_btn_1.set_style_text_font(test_font("SourceHanSerifSC_Regular", 16), lv.PART.MAIN|lv.STATE.DEFAULT)
...
screen_1_cont_1.set_size(240, 320)
...
screen_1_img_1 = lv.img(screen_1_cont_1)
screen_1_img_1.set_src("B:MicroPython/_dog1_alpha_240x320.bin")
...
screen_1_img_1.set_size(240, 320)
...
screen_1_img_1.set_style_radius(0, lv.PART.MAIN|lv.STATE.DEFAULT)
screen_1_img_1.set_style_clip_corner(True, lv.PART.MAIN|lv.STATE.DEFAULT)

# Create screen_1_btn_1
screen_1_btn_1 = lv.btn(screen_1_cont_1)
screen_1_btn_1_label = lv.label(screen_1_btn_1)
screen_1_btn_1_label.set_text("汪汪")
...
screen_1_btn_1.set_style_text_font(test_font("SourceHanSerifSC_Regular", 16), lv.PART.MAIN|lv.STATE.DEFAULT)
